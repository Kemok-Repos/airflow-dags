...
with DAG(
    dag_id='bago-caricam-actualizacion-mensual-de-aplicacion-de-proyecciones-de-venta',
    ...
    t1 = build_processing_tasks(connection_id='bago_caricam_app', repo='bago-caricam-sql/actualizar-mes-en-app')
