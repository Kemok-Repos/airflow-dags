...
from utils import get_query_from_file, get_task_name, run_query, join_dicts, insert_error_to_log
...
if __name__ == '__main__':
    tt = TransferTasks(client='kemok bi', condition='test')
    tt.get_transfer_tasks()
    pprint(tt.task_groups())
